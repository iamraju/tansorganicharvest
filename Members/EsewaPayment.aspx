...
<body class="bg-green-50 min-h-screen flex items-center justify-center">
    ...
    <!-- Visible to user for ~1 second before auto-submit -->
    ...
    <!-- Hidden auto-submitting form to eSewa gateway -->
    <form id="esewaForm" method="POST"
    ...
    <script>
        // Auto-submit after 800ms so the user sees the redirect message
        setTimeout(function () {
            var form = document.getElementById('esewaForm');

            // Build proper input fields from hidden fields
            // (eSewa needs name= attributes matching the API spec)
            var fields = {
